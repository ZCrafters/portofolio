  ...
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          name: 'Kardiovaskular Prediction',
          imageUrl: 'jantung',
          status: 'Kardiovaskular Diases prediction with streamlit app.',
          tech: 'Python, streamlit',
          github: 'https://github.com/ZCrafters/Kardiovaskular',
          demo: 'https://kardiovaskular-prediction-disease.streamlit.app/'
        },
        {
          id: 2,
          name: 'Portfolio',
